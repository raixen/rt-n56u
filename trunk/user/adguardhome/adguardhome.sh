...
dl_adg(){
logger -t "AdGuardHome" "下载AdGuardHome"; mkdir -p /tmp/AdGuardHome/
...
[ $? != 0 ] && sleep 20 && wget -c -O /tmp/AdGuardHome/AdGuardHome https://github.com/eprea/cdn/raw/master/AdGuardHome
